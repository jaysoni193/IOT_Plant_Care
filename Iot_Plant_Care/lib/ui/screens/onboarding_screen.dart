  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          PageView(
            onPageChanged: (int page){ // To view Page View
              setState(() {
                currentIndex = page;
              });
            },
            controller: _pageController,
            children: [                     //First Screen
              createPages(image: 'assets/images/plant1.png',
              title: Constants.titleOne,
              description: Constants.descriptionOne,
              ),
              createPages(image: 'assets/images/plant2.png',
                title: Constants.titleTwo,
                description: Constants.descriptionTwo,
              ),
              createPages(image: 'assets/images/plant3.png',
...
class createPages extends StatelessWidget {
  final String image;
  final String title;
